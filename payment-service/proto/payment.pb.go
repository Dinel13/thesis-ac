...
var file_proto_payment_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x69, 0x73, 0x50, 0x61, 0x79, 0x32, 0x9c, 0x01, 0x0a,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a, 0x0d, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x50,
	0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x1b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x56,
	0x65, 0x72, 0x69, 0x66, 0x79, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x50, 0x61, 0x79, 0x6d,
	0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x08, 0x5a, 0x06, 0x70,
...
var file_proto_payment_proto_depIdxs = []int32{
	0, // 0: proto.PaymentService.CreatePayment:input_type -> proto.CreatePaymentRequest
	1, // 1: proto.PaymentService.VerifyPayment:input_type -> proto.VerifyPaymentRequest
	2, // 2: proto.PaymentService.CreatePayment:output_type -> proto.PaymentResponse
	2, // 3: proto.PaymentService.VerifyPayment:output_type -> proto.PaymentResponse
...
type PaymentServiceClient interface {
	...
	VerifyPayment(ctx context.Context, in *VerifyPaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error)
}
...
func (c *paymentServiceClient) VerifyPayment(ctx context.Context, in *VerifyPaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error) {
	out := new(PaymentResponse)
	err := c.cc.Invoke(ctx, "/proto.PaymentService/VerifyPayment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServiceServer interface {
	...
	VerifyPayment(context.Context, *VerifyPaymentRequest) (*PaymentResponse, error)
}
...
func (*UnimplementedPaymentServiceServer) VerifyPayment(context.Context, *VerifyPaymentRequest) (*PaymentResponse, error) {
...
func _PaymentService_VerifyPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.PaymentService/VerifyPayment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
