...
func ReadEasyJson(request *http.Request, data *domain.PaymentRequest) error {
...
func WriteEasyJson(w http.ResponseWriter, status int, data *domain.PaymentWrapper) error {
